...
const App: React.FC = () => {
  ...
  const exportAnalysisMarkdown = useCallback(() => {
    ...
    lines.push('');
    lines.push(`> Generated by [GitMind Pro](https://gitmindpro.vercel.app) on ${new Date().toLocaleDateString()}`);
    lines.push('');
    lines.push('## Summary');
    ...
    lines.push('---');
    lines.push(`![GitMind Score](https://gitmindpro.vercel.app/api/badge?owner=${repo.owner}&repo=${repo.repo})`);
